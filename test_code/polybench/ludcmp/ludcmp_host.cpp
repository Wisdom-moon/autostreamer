		   ...
		   DATA_TYPE POLYBENCH_1D(y,N,n))
{
  ...
  cl_mem y_mem_obj = clCreateBuffer(clGPUContext, CL_MEM_READ_WRITE, (((((n)-1))-1)+ 1)* sizeof (double ), NULL, NULL);
  int i, j, k;
...
clSetKernelArg(clKernel, 3, sizeof(cl_mem), (void *) &y_mem_obj);
DeltaT();
